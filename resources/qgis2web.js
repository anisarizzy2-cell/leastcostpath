...
map.getView().fit([12538204.468831, -819080.962318, 12566529.210569, -804161.614312], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">HASIL ANALISIS LEAST COST PATH</h2>';
        return titleElement;
    })(),
